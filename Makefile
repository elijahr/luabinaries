...
# default is linux "x64" aka x86 64bit
...
lua51-macos:
	...
	@mv lua-$(VERSION)/src/lua build/macos/lua51-macos-x64
	@mv lua-$(VERSION)/src/luac build/macos/luac51-macos-x64
	@rm -rf lua-$(VERSION)

lua53-macos: VERSION := 5.3.6
lua53-macos:
	$(call build_lua_macos,lua-${VERSION})
	@mv lua-$(VERSION)/src/lua build/macos/lua53-macos-x64
	@mv lua-$(VERSION)/src/luac build/macos/luac53-macos-x64
	@rm -rf lua-$(VERSION)

lua54-macos: VERSION := 5.4.8
lua54-macos:
	$(call build_lua_macos,lua-${VERSION})
	@mv lua-$(VERSION)/src/lua build/macos/lua54-macos-x64
	@mv lua-$(VERSION)/src/luac build/macos/luac54-macos-x64
	@rm -rf lua-$(VERSION)
